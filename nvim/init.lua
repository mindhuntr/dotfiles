...
-- Restore Cursor 
-- Save the original cursor shape on startup
-- Define autocmd group
-- Initialize cursor_pos variable at the beginning of your Lua configuration

-- Define autocmd group
-- vim.api.nvim_set_var('cursor_pos', vim.fn.getpos('.'))
-- vim.cmd [[
--   augroup remember_cursor_position
--     autocmd!
--     autocmd BufReadPost * lua SaveCursor()
--     autocmd VimLeave * lua SaveCursor()
--     autocmd VimEnter * lua RestoreCursor()
--   augroup END
-- ]]
-- 
...
--   local cursor_pos = vim.api.nvim_get_var('cursor_pos')
--   if cursor_pos and type(cursor_pos) == 'table' then
--     vim.fn.setpos('.', cursor_pos)
--   end
-- end
-- Save cursor state before leaving Neovim
